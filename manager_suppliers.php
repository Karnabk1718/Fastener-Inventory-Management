...
.date-cell{font-family:'DM Mono',monospace;font-size:13px;}
...
.navbar,.pill,.icon-btn,.logout-btn,.btn-export,.count-badge,.readonly-notice,.table-card,.search-box,.page-title-icon{border-color:#000!important;}
