...
<style>
:root{--bg-from:#1a3a6b;--bg-to:#2d5fa6;--text:#fff;--muted:rgba(255,255,255,0.65);--gold:#ffd700;--gold-bg:rgba(255,215,0,0.15);--gold-br:rgba(255,215,0,0.40);--card-bg:rgba(0,0,0,0.35);--card-bdr:rgba(255,255,255,0.16);--input-bg:rgba(0,0,0,0.35);--input-bdr:rgba(255,255,255,0.25);--thead-bg:rgba(0,0,0,0.45);--row-bdr:rgba(255,255,255,0.10);--row-hover:rgba(255,255,255,0.06);}
...
.main{padding:28px 28px 50px;max-width:1300px;margin:0 auto;}
...
.page-title h1{font-size:22px;font-weight:600;margin-bottom:2px;}
...
.low-badge{background:rgba(255,107,107,0.16);border:1px solid rgba(255,107,107,0.35);color:#fecaca;border-radius:20px;padding:5px 14px;font-size:13px;font-weight:600;}
...
.readonly-notice{background:rgba(96,165,250,0.12);border:1px solid rgba(96,165,250,0.30);color:#93c5fd;border-radius:10px;padding:10px 16px;font-size:13px;margin-bottom:18px;display:flex;align-items:center;gap:8px;}
.table-card{background:var(--card-bg);border:1px solid var(--card-bdr);border-radius:16px;overflow:hidden;}
.table-card-header{padding:16px 22px;border-bottom:1px solid var(--card-bdr);display:flex;align-items:center;justify-content:space-between;gap:12px;}
.table-card-header h3{font-size:14px;font-weight:600;display:flex;align-items:center;gap:8px;}
.table-card-header h3::before{content:'';width:3px;height:14px;background:var(--gold);border-radius:2px;}
.search-box{background:var(--input-bg);border:1px solid var(--input-bdr);border-radius:8px;padding:7px 13px;color:#fff;font-family:inherit;font-size:13px;outline:none;width:220px;}
...
th{padding:12px 16px;text-align:left;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:rgba(255,255,255,0.90);}
td{padding:13px 16px;border-bottom:1px solid var(--row-bdr);color:#fff;font-weight:500;vertical-align:middle;}
tbody tr:last-child td{border-bottom:none;}
tbody tr:hover{background:var(--row-hover);}
tbody tr.low-row td{background:rgba(255,107,107,0.06);}
.id-cell{font-family:'DM Mono',monospace;font-size:12px;color:rgba(255,255,255,0.65);}
.name-cell{font-weight:600;}
.part-cell{font-family:'DM Mono',monospace;font-size:12px;color:var(--muted);word-break:break-word;}
.type-pill{background:rgba(255,215,0,0.18);border:1px solid rgba(255,215,0,0.40);color:var(--gold);border-radius:20px;padding:4px 12px;font-size:12px;font-weight:600;}
.qty-ok{color:#4ade80;font-family:'DM Mono',monospace;font-weight:700;}
.qty-low{color:#ff6b6b;font-family:'DM Mono',monospace;font-weight:700;}
.stock-ok{background:rgba(74,222,128,0.15);border:1px solid rgba(74,222,128,0.35);color:#4ade80;border-radius:20px;padding:3px 10px;font-size:11px;font-weight:700;}
.stock-low{background:rgba(255,107,107,0.15);border:1px solid rgba(255,107,107,0.35);color:#fecaca;border-radius:20px;padding:3px 10px;font-size:11px;font-weight:700;}
.thumb{width:46px;height:46px;object-fit:cover;border-radius:8px;border:1px solid var(--card-bdr);}
.no-img{width:46px;height:46px;border-radius:8px;background:rgba(255,255,255,0.07);border:1px dashed rgba(255,255,255,0.20);display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,0.25);font-size:16px;}
:root{--bg-from:#dff3ff;--bg-to:#b9e3ff;--text:#071827;--muted:#315166;--gold:#0b4f8a;--gold-bg:#d8efff;--gold-br:#000;--card-bg:rgba(255,255,255,0.82);--card-bdr:#000;--input-bg:#fff;--input-bdr:#000;--thead-bg:#c7e8fb;--row-bdr:#000;--row-hover:#d5ecff;}
body.dark{--bg-from:#dff3ff;--bg-to:#b9e3ff;--card-bg:rgba(255,255,255,0.82);--card-bdr:#000;}
.navbar,.pill,.icon-btn,.logout-btn,.btn-export,.count-badge,.low-badge,.readonly-notice,.table-card,.search-box,.page-title-icon,.type-pill,.stock-ok,.stock-low,.thumb,.no-img{border-color:#000!important;}
.navbar{background:rgba(223,243,255,0.92);}
.nav-links a,.pill,td,th,.btn-export{color:#071827;}
.nav-links a:hover,.nav-links a.active,.icon-btn:hover,.logout-btn:hover,.btn-export:hover{background:#073b78!important;color:#fff!important;border-color:#000!important;text-decoration:none;}
.table-card:hover,.readonly-notice:hover{background:#073b78!important;border-color:#000!important;color:#fff;}
.table-card:hover *,.readonly-notice:hover *{color:#fff!important;}
