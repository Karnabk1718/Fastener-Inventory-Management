...
<style>
:root{--bg-from:#1a3a6b;--bg-to:#2d5fa6;--text:#ffffff;--muted:rgba(255,255,255,0.65);--gold:#ffd700;--gold-bg:rgba(255,215,0,0.15);--gold-br:rgba(255,215,0,0.40);--card-bg:rgba(0,0,0,0.35);--card-bdr:rgba(255,255,255,0.16);--input-bg:rgba(0,0,0,0.35);--input-bdr:rgba(255,255,255,0.25);--thead-bg:rgba(0,0,0,0.45);--row-bdr:rgba(255,255,255,0.10);--row-hover:rgba(255,255,255,0.06);}
...
.search-box{background:var(--input-bg);border:1px solid var(--input-bdr);border-radius:8px;padding:7px 13px;color:#fff;font-family:inherit;font-size:13px;outline:none;width:220px;transition:border-color 0.2s;}
...
.size-cell{font-family:'DM Mono',monospace;font-size:13px;}
...
.empty-state{text-align:center;padding:48px 20px;color:rgba(255,255,255,0.45);}
...
.navbar,.pill,.icon-btn,.logout-btn,.btn-export,.count-badge,.readonly-notice,.table-card,.search-box,.page-title-icon,.type-pill,.thumb,.no-img{border-color:#000!important;}
