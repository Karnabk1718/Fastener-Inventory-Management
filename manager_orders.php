...
.pending-badge{background:rgba(251,191,36,0.15);border:1px solid rgba(251,191,36,0.35);color:#fbbf24;border-radius:20px;padding:5px 14px;font-size:13px;font-weight:600;}
.deliv-badge{background:rgba(74,222,128,0.15);border:1px solid rgba(74,222,128,0.35);color:#4ade80;border-radius:20px;padding:5px 14px;font-size:13px;font-weight:600;}
...
.filter-btn{background:rgba(255,255,255,0.10);border:1px solid rgba(255,255,255,0.18);color:#fff;border-radius:20px;padding:5px 14px;font-size:12px;font-weight:600;cursor:pointer;transition:0.2s;}
.filter-btn:hover,.filter-btn.active{background:rgba(255,215,0,0.20);border-color:var(--gold);color:var(--gold);}
...
.navbar,.pill,.icon-btn,.logout-btn,.btn-export,.filter-btn,.count-badge,.pending-badge,.deliv-badge,.readonly-notice,.table-card,.search-box,.page-title-icon,.badge{border-color:#000!important;}
.navbar{background:rgba(223,243,255,0.92);}
.nav-links a,.pill,td,th,.btn-export{color:#071827;}
.nav-links a:hover,.nav-links a.active,.icon-btn:hover,.logout-btn:hover,.btn-export:hover,.filter-btn:hover,.filter-btn.active{background:#073b78!important;color:#fff!important;border-color:#000!important;text-decoration:none;}
